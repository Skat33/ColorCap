...
<body>
    ...
    <article>
        <div class="container">
            ...
            include 'dane_mistrzostwa.php'; //Dane dotyczące meczów, danej rundy, administratora i daty obstawienia.
            include 'punkty.php'; //Dane dotyczące aktualizowania punktów użytkowników
            ...
            ORDER BY wyniki.Punkty DESC LIMIT 10"; // Pobranie 10 użytkowników mających najwięcej punktów
            ...
            while ($row_user = mysqli_fetch_assoc($query_users)) {
                ...
                while ($row2 = mysqli_fetch_array($result2)) {
                    ...
                    $mistrz_sql = "UPDATE wyniki SET Mistrz = '$mistrz' WHERE ID = $user_id"; //Wyświetlenie wytypowanego mistrza przez użytkownika
            ...
            echo '<table id="tabela" border="2" cellspacing="0" >';
                foreach ($columns as $column){
                    ...
                    echo '<th style="background-color: #111;">'.$column->name.'</th>'; // Wyświetlanie nagłówków tabeli, Np. Runda1 etc.
                    }
                }
                echo '<tr></tr>';
            $i=1;
            ...
            while ($row = mysqli_fetch_assoc($result)){    
                ...
                foreach ($row as $key => $value){
                    if ($key === "ID"){
                        ...
                        echo '<td style="color: yellow; font-size: 20px;">'.$value.'</td>'; // Wyświetlanie danych z danej kolumny
                    }else{
                    echo '<td>'.$value.'</td>';
                    }
