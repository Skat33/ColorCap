...
<body>
    ...
    <article>
        <div class="container">
            ...
            echo '</select></form>';
            echo '<span class="runda">Runda: </span><span class="rundaif" style="color: white;">'.$wybrana_runda.'</span>';
            ...
            if (mysqli_num_rows($result2) == 0) {
                ...
                if (mysqli_num_rows($wytypowany_result) == 0) {}else{
    ...
    <script>
        ...
        document.getElementById('userSelect').addEventListener('change', function () {
            ...
            var selectedRound = currentRound;
            window.location.href = 'tabela.php?users=' + selectedUser + '&selected-rounds=' + selectedRound;
        });
    </script>
</body>
