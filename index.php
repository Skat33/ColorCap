    ...
    <body>
                ...
                <div class="konto">
                    ...
                    <div class="user-info">
                        ...
                        include 'session.php';
                            ...
                            echo "<span style='position: relative; top: -20px;'>".$imie." ".$nazwisko."</span>"; // Po najechaniu na zakładke konto wyświetlą się dane w okienku
                            $conn->close()
                        ?>
        ...
        <article>
            <div class="container">
                ...
                Lista uczestników Mistrzostw Europy obejmuje 21 z 24 drużyn, w tym Reprezentację Polski, która zakwalifikowała się poprzez baraże.<br><br><br>
                <center> <span style="font-weight: bold; font-size: 22px;">Regulamin</span> </center>
                <b>Przebieg gry:</b><br>
                Gra podzielona jest na 5 etapów (faza grupowa, 1/8 finału, ćwierćfinały, półfinały i finał), przy czym etap nr 1(Faza Grupowa) jest podzielony na 3 rundy. Na każdym z etapów dostajemy kartę do typowania, na której obstawiamy bramkowy wynik meczów (np.2:1). Po każdym z etapów zostanie wywieszona tabela wyników, aby gracze mogli kontrolować swoje postępy.<br><br>
                ...
                <ul>
                    ...
                    <li>Obstawienie różnicy bramkowej (np. obstawienie wyniku 3:1, przy faktycznym rezultacie 2:0 tj. dwie bramki różnicy - <b>2pkt</b></li>
                ...
                <ol>
                    ...
                    <li>W wypadku, gdy dwóch lub więcej graczy ma tyle samo punktów to priorytetowe znaczenie dla wyniku zawodów mają punkty za mecze reprezentacji Polski.</li>
                    <li>W wypadku, gdy dwóch lub więcej graczy ma tyle samo punktów, oraz tyle samo punktów za mecze reprezentacji Polski to priorytetowe znaczenie dla wyniku zawodów ma ilość poprawnie wytypowanych faktycznych wyników meczów.</li>
                    <li>W kolejnych przypadkach o kolejności decyduje organizator zawodów.</li>
                </ol>
                <b>Wygrana:</b><br>
                Organizator zastrzega sobie prawo do podziału wygranej w zależności od ilości uczestników gry – przewidywana jest wygrana za zwycięstwo lub wygrana za trzy pierwsze miejsca.
            </div>
        </article>
        <script>
            function logout() {
