        ...
        ?>
            ...
            <article>
                <div class="container">
                    ...
                    <hr style="top: 10px;">
                    <img src="user.jpg" style="position: relative; left: 59%;" alt="user" width="175px" height="200px" class="user-img">
                    <span class="nick"><?php include 'database_data.php'; include 'dane_mistrzostwa.php'; echo $username; ?></span>
                    <span class="user-rank"><?php if($username!==$admin){echo 'User';}else{echo '<span style="color: red; font-weight:bold; letter-spacing: 1px; margin-left: -5px;">Admin</span>';}?></span>
                    <div class="tekst">
                        <?php
                        include 'data.php';
                        include 'database_data.php';
                        
                        echo "<span style='font-weight: bold; color: orange; margin-right: 15px;'>Imie:</span>  $imie<br>";
                        echo "<span style='font-weight: bold; color: orange; margin-right: 15px;'>Nazwisko:</span>  $nazwisko<br>";
                        echo "<span style='font-weight: bold; color: orange; margin-right: 15px;'>E-mail:</span>    $email<br><br>";
                        echo "<i style='font-size: 16px; '>UWAGA! W przypadku potrzeby zmiany hasła lub maila <br>należy kontaktować się bezpośrednio z administratorem!</i>";
                        ?>
                    </div>
                </div>
            </article>
